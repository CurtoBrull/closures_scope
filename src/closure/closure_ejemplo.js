...
// <-- este paréntesis indica que la función se está ejecutando.

/* Este paréntesis indica que la función se está ejecutando, es decir cada línea de esa función se ejecuta una a una, y si recorremos línea a línea a la función tenemos la declaración de cantidadDeHijos que vale 0
